...
!!! info "Професійний профіль"
    ...
    *   Досвід **20+ років** на інженерно-технічних посадах (інженер автоматизованих систем управління виробництвом / системний адміністратор / керівник групи ІТ/).
    *   Експертиза індивідуальної підтримки **100+ користувачів**,практика підтримки **10+ критичних IT-сервісів**, робота з CMDB та тікет системами.    
    *   Розуміння мережевих інфраструктур, ПЗ, баз даних.
    *   Перехід у **QA Manual** з потужним технічним бекендом.

*   :material-translate: **Англійська:** B1 (Upper-Intermediate terminology)
*   :material-human-greeting: **Soft Skills:** індивідуальний так командний досвід роботи,  ,аналітичне мислення.
